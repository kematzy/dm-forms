...
* fix issue with methods resolving to outter scope even when using instance_eval ... might work fine with EventContext
...
* Aggregate / faux elements ... 
  * datefield :bday, :format => 'YYYY-MM-DD', :value => '1987-05-25'
