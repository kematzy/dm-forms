...
13.24      0.75     0.75     0.00     0.00       84  String#<<
 2.23      5.41     0.13     0.00     5.29       21  DataMapper::Form::Helpers#form

* benchmark with mixins as well
* add #use DSL for adding mixins
* get rid of origin.buffer ... causing the memory issues .. what is merbs technique?
* memory error in benchmarks?
* remove bound submit? others?
...
* fix elements duplicating above the form
